<template>
  <TemplateRegister src="https://saclogistica.com.br/wp-content/uploads/2022/07/Almoxarifado-930x620.png">
      <div class="content">
      <div class="txt">
          <h1>Esqueceu sua senha?</h1>
          <p>Para redefinir a sua senha, informe o endereço de e-mail e código da empresa cadastrados na sua conta e lhe enviaremos um link com as instruções.</p>
      </div>
      ...
      <div class="form-style">
        <h3>Código da empresa</h3>
        <BaseInput class="input"></BaseInput>
      </div>

      <Button  intent="primary" @click="updateText">Redefinir senha</Button>
      </div>
  </TemplateRegister>
</template>
